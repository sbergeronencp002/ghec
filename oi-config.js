...
const OI_CONFIG = {
"Situer dans le temps": {color: "var(--c-slot1)", bg: "var(--c-slot1-bg)", soustags: ["Situer avant et après", "Situer sur une ligne du temps", "Placer en ordre chronologique"]},
"Situer dans l'espace": {color: "var(--c-slot2)", bg: "var(--c-slot2-bg)", soustags: ["Situer 1 élément dans l'espace", "Situer 2 éléments dans l'espace"]},
